...
Responsibilities
----------------
* Develop and optimize new and existing machine learning tools and products leveraging the best of breed clustering and classification techniques 
* Actively develop new algorithms and fine-tune existing ones to take advantage of massive Huffington Post data sets to build exciting and innovative new products
